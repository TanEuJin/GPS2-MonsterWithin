...
Properties {
	...
	_LightSource_Pos ("_LightSource_Pos", Vector) = (0,0,0,1)
}
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	float alpha = (1.0 - (baseColor.a + powerForPos(_Player1_Pos, IN.location) + powerForPos(_LightSource_Pos, IN.location)));
